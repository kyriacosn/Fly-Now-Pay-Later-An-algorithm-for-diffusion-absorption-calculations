...
class simulation_analysis:
    ...
    def slsqp_optimize(self,K,k0):
        ...
        return sc.optimize.minimize(wrap_phi, args= (self), x0=k0, bounds=[(0,K*self.t_states) for i in range(self.t_states)], constraints=cons,method="SLSQP", options={ 'maxiter': 100, 'ftol': 1e-08, 'iprint': 1, 'disp': False, 'eps': 0.01, 'finite_diff_rel_step': None} )
